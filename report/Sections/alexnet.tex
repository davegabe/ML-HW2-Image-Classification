...
It has been trained using Google Colab with a GPU runtime and the training took about 1 hour.
The training and validation accuracy are shown in Figure~\ref{fig:alexnet-accuracy} for both learning rates.
As we can see, a learning rate of 0.001 is too high and the model does not converge.

\begin{figure}[h]
    \centering
    \subfloat[\centering Learning Rate = 0.001]{{\includegraphics[width=0.45\textwidth]{../plot/alexnet-accuracy-lr-0001.png}}}
    \qquad
    \subfloat[\centering Learning Rate = 0.0001]{{\includegraphics[width=0.45\textwidth]{../plot/alexnet-accuracy-lr-00001.png}}}
...
\begin{figure}[h]
    \centering
    \subfloat[\centering Learning Rate = 0.001]{{\includegraphics[width=0.45\textwidth]{../plot/alexnet-confusion-matrix-lr-0001.png}}}
    \qquad
    \subfloat[\centering Learning Rate = 0.0001]{{\includegraphics[width=0.45\textwidth]{../plot/alexnet-confusion-matrix-lr-00001.png}}}
